...
import { Target, Calendar, Trophy, Footprints } from "lucide-react";
import GoalTab from "@/components/plan/GoalTab";
import TrainingTab from "@/components/plan/TrainingTab";
import RacesTab from "@/components/plan/RacesTab";
    ...
    <div className="space-y-6">
      <ScrollReveal>
        <div>
          ...
          <p className="text-sm text-muted-foreground">Objectif, entraînement, courses et équipement</p>
        </div>
      </ScrollReveal>

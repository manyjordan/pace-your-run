...
import { Search, MapPin, Calendar, Mountain, ArrowUpRight, Trophy } from "lucide-react";
...
const Races = () => {
  ...
  return (
    <div className="space-y-6">
      <ScrollReveal>
        <h1 className="text-2xl font-bold tracking-tight md:text-3xl">Race Finder</h1>
        <p className="text-sm text-muted-foreground">Discover and prepare for your next race</p>
      </ScrollReveal>
              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {race.registered && (
                      <span className="rounded bg-accent/20 px-1.5 py-0.5 text-[10px] font-bold text-lime">
                        REGISTERED
                      </span>
                    )}
                  </div>
